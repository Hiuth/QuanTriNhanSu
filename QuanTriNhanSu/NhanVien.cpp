...
void NhanVien::PrintEmployeeInfotmation() {
    ...
    cout << "STT" << "\t" << "Ten Nhan Vien"<<"\t" << "\t" << "\t" << "Gioi Tinh" << "\t" << "Sinh Nhat" << "\t" << "Can cuoc cong dan" << "\t" << "Dia chi" << "\t" << "\t" << "\t" << "Phong ban" << " " << "\t" << "\t" << "Chuc vu"  "\t" << "\t" << "Ma nhan vien" << endl;
    while (res->next()) {
        cout << ++count << "\t" << res->getString("TenNhanVien") <<"\t" << "\t" << "\t" << res->getString("GioiTinh") << "\t" << "\t" << res->getString("SinhNhat") << "\t" << res->getString("CCCD") << "\t" << "\t" << res->getString("DiaChi") << "\t" << "\t" << "\t" << res->getString("PhongBan") << "\t" << "\t"<<"\t" << res->getString("ChucVu") << "\t" << "\t" << res->getString("MaNhanVien") << endl;
        cout << endl;
    }
    delete res;
    delete stmt;
...
void NhanVien::SearchEmployee(string ten, string ma) {
    ...
    while (true) {
        if (res->next()) {
            ...
            cout << "Ten Nhan Vien" << "\t" << "\t" << "\t" << "Gioi Tinh" << "\t" << "Sinh Nhat" << "\t" << "Can cuoc cong dan" << "\t" << "Dia chi" << "\t" << "\t" << "\t" << "Phong ban" << " " << "\t" << "\t" << "Chuc vu" << "\t"<<"\t"<<"Ma nhan vien" << endl;
            cout << res->getString("TenNhanVien") << "\t" << "\t" << "\t" << res->getString("GioiTinh") << "\t" << "\t" << res->getString("SinhNhat") << "\t" << res->getString("CCCD") << "\t" << "\t" << res->getString("DiaChi") << "\t" << "\t" << "\t" << res->getString("PhongBan") << "\t" << "\t" << "\t" << res->getString("ChucVu") << "\t" << "\t"<<res->getString("MaNhanVien") << endl;
            cout << endl;
